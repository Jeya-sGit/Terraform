...
###################################################
variable "aws_region" {
  description = "The AWS region to deploy resources in. Used by providers.tf."
  type        = string
  default     = "ap-south-1"
}
...
###################################################
# VPC Variables (Passed to the VPC Module)
###################################################
variable "vpc_cidr" {
...
###################################################
# Compute Variables (Passed to the Compute Module)
###################################################
